...
echo 'pushing image nodejs-webapp'
${CONTAINER_RUNTIME} tag nodejs-webapp ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/nodejs-webapp
${CONTAINER_RUNTIME} push ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/nodejs-webapp
